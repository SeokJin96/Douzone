/*
 OOP 객체 지향 프로그래밍 (여러개의 작은 조각(작은 설계도)만들어서 조합하는 행위)
  >> 설계도 재사용 
 ...
 문법)
 1. 함수의 이름은 같고 parameter 개수와 타입을 달리한다
 1.1 함수의 이름 동일
 1.2 parameter 개수 타입을 달리한다
 1.3 return type 오버로딩의 판단 기준이 아니다
 1.4 parameter 의 순서가 다름을 인정
...
class OverT{ //설계도
	...
	//POINT
	void add(Human human) { //인정 class는 데이터 타입이 될 수 있다.
		human.age = 100;
		human.name="할아부지";
	}
