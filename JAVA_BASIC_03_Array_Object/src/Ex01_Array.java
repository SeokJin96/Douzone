...
public class Ex01_Array {
	...
	public static void main(String[] args) {
		...
		int [] arr3 = {11,22,33};
		//Tip) const arr = [1,2,3,4,5]; 			let arr=[100,200]; // javascript
		...
		//배열은 객체다 (new ... heap)
		int[] arr4; // stack arr4 변수 생성 (null)
		arr4 = new int[] {21,22,23,24};
		System.out.println(arr4); // [I@1eb44e46 주소값을 갖고 있는다.
		
		int[] arr5 = arr4; // 주소값 할당
		//같은 메모리를 보고 있다.
		System.out.println(arr5 == arr4); //true
		
		//배열의 타입 : 8 + 1(String) + 클래스(타입)
